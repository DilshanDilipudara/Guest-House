                            ...
                            {{ csrf_field() }}
                              ...
                              <div class="form-group">
                                  ...
                                  <label for="Empno" class="form-control"  class="col-md-4 control-label">Employee Number</label>
                                      <input id="Empno" type="text"readonly="readonly" class="form-control" name="Empno" value="{{$user->Empno}}" required autofocus  >
                                      <span class="input-group-addon">
                                          <i class="glyphicon glyphicon-user"></i>
                                      </span>
                                      @if ($errors->has('Empno'))
                              ...
                              <div class="form-group">
                                  ...
                                  <label for="Nicno" class="form-control"  class="col-md-4 control-label">NIC</label>
                                      <input id="Nicno" type="text" min="10" max="12"readonly="readonly" class="form-control" name="Nicno" value="{{$user->Nicno}}" placeholder="read only"required autofocus  >
                                      <span class="input-group-addon">
                                          <i class="glyphicon glyphicon-user"></i>
                                      </span>
                                      @if ($errors->has('Nicno'))
