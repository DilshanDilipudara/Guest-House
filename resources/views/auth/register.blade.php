        ...
        <div class="container">
            <div class="booking-content">
                <div class="booking-image">
                    <img class="booking-img" src="images/22.jpg" alt="Booking Image">
                </div>
                <div class="booking-form">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="form-group form-input" class="form-group{{ $errors->has('Empno') ? ' has-error' : '' }}" >
                            <input id="Empno" type="number" min="0"  name="Empno"   value="{{ old('Empno') }}" required >
                        ...
                        <div class="form-group form-input" class="form-group{{ $errors->has('Nicno') ? ' has-error' : '' }}" >
                            <input id="Nicno" type="text" name="Nicno" pattern="[0-9]+v" title="please end with v " value="{{ old('Nicno') }}" required >
